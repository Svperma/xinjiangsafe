...
<title>My JSP 'insertInveStigate.jsp' starting page</title>
...
<body>
	<form action="${basePath }evaluateDangers/riskRatingInsert"
		...
		<div style="padding-left:30px;float:left;">
			<img src="images/icotit2.jpg" width="40" height="40"> <input
				type="hidden" value="${userCorpDangerSource.USERCODE }"
				name="userCode" id="userCode"> <input type="hidden"
				value="${userCorpDangerSource.CLASSCODE }" name="CLASSCODE"
				id="CLASSCODE"> <input type="hidden"
				value="${userCorpDangerSource.COMPANYNAME }" name="COMPANYNAME"
				id="COMPANYNAME">
		</div>
		<div class="neicont_main_left_cont_main">
					...
					<td colspan="1">
						...
						<div class="select_list" style="width: 200px;">
							<input class="select_list_inputa"
								style="  width: 180px;height:30px;" type="text" maxlength="20"
			...
			<div class="pages">
				<ul id="ul_back">
					<li><a class="a_back" href="javascript:submitFm();">提交</a></li>
					<li><a class="a_back" href="javascript:history.go(-1);">返回</a></li>
				</ul>
			</div>
		</div>
	</form>
