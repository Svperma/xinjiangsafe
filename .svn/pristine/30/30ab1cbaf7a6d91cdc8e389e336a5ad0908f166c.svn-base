...
<input type="hidden" id="comLevel" value="${sessionScope.ggUser.comLevel }">
   	<div class="neicont_main_left_cont">
		...
		<div style="width:100%;text-align:left;">
			人数区间:<input id="renshu1" name="renshu1" class="select_list_inputa" style="width: 80px" placeholder="最小数" value=""/>--
	...
	<iframe name="resultFrame" style="background-color:#F1F1F1;margin-top:10px;" src="/policyinfo/mycheckinitjg" width="100%" frameborder="0" height="100%">
	</iframe>
<script type="text/javascript">
	/* 查询方法 */
	function queryPreventive(){
		...
		var url = "${basePath }/policyinfo/mycheckqueryjg";
	...
	function exportExcel() {
		...
		fm.action = "${basePath}/policyinfo/exportPolicy";
		fm.submit();
	}
</script>
  </body>
