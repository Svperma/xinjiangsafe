  ...
  <body>
	...
	<input type="hidden" id="comLevel" value="${sessionScope.ggUser.comLevel }">
    	<div class="neicont_main_left_cont">
        	<div class="neicont_img"><img src="images/icotit1.jpg">预防费查询</div>
	...
	<iframe name="resultFrame" style="background-color:#F1F1F1;margin-top:10px;" src="/dsmanager/preventive_costResult.jsp" width="100%" frameborder="0" height="100%">
	</iframe>
<script type="text/javascript">
	/* 查询方法 */
	function queryPreventive(){
		var url = "${basePath }/dsmanager/queryPreventive";
...
<script type="text/javascript">
	function exportExcel() {
		...
		fm.action = "${basePath}/dsmanager/exportToExcel";
		fm.submit();
	}
</script>
  </body>
