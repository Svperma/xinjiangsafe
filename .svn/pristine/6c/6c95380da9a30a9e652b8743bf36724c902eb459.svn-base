	 ...
	 <div class="tab-top-div">
		...
		<table class="nav-tab">
			...
			<tr>
				...
				<td colspan="7"><input id="inName" name="inName" type="text" value=""></td>
			</tr>
			<tr>
...
财产损失免赔额为人民币1000元</td>
			...
			<tr>
				...
				<td colspan="1">
				 <input id="itemFour" name="itemFour" type="checkbox">
				</td>
  ...
  <div id="showForm" style="dborder:1px solid red;height:3000px;background:#333;opacity:0.8;position:absolute;width:100%;top:0;display: none;">
    ...
    function isEmpty(id) {
    	...
    	if(val == null) {
			alert($('#id').parent('td').prev('td').text());
    	}
    }
    
    function goZus(){
    	isEmpty("alSafetyLicenseNo");
