...
<input type="hidden" id="comLevel" value="${sessionScope.ggUser.comLevel }">
   	<div class="neicont_main_left_cont">
       	<div class="neicont_img"><img src="images/icotit1.jpg">理赔查询</div>
           <div class="neicont_main_left_cont_main">
           <form action="${basePath }/dsmanager/claimQuery" name="fm" id="fm" method="post" target="resultFrame">
			...
			<div class="select_list">
					<div id="uboxstyle">
						<select name="whyInsure" id="whyInsure">
							<option value="" selected="selected">选择结案状态</option>
	...
	<iframe name="resultFrame" style="background-color:#F1F1F1;margin-top:10px;" src="/dsmanager/claimQueryResult.jsp" width="100%" frameborder="0" height="100%">
	</iframe>
<script type="text/javascript">
	/* 查询方法 */
	function queryPreventive(){
		var url = "${basePath }/dsmanager/claimQueryResult";
...
<script type="text/javascript">
	function exportExcel() {
		...
		fm.action = "${basePath}/dsmanager/exportClaim";
		fm.submit();
	}
</script>
  </body>
