...
<body>
	<div class="maincont_mid_cont_right_main">
		<input type="hidden"
			value="${sessionScope.govExpertByExpCode.expcode }" name="expcode"
			id="expcode">
		<table cellpadding="0" cellspacing="0" width="100%" border="0">
			<tr class="table_head">
				<td colspan="4">专家明细</td>
			</tr>
			<tr>
				...
				<td style="border-bottom:1px solid #CCC;border-left:1px solid #CCC;">
					${sessionScope.govExpertByExpCode.exName }</td>
				<td
				...
				<td style="border-bottom:1px solid #CCC;border-left:1px solid #CCC;">
					<span style="font-size: 16px;" name="address" id="address">
						<tlds:name codeCode='${sessionScope.govExpertByExpCode.province }'
							codeType='Province'></tlds:name> <tlds:name
							codeCode='${sessionScope.govExpertByExpCode.city }'
							codeType='City'></tlds:name> <tlds:name
							codeCode='${sessionScope.govExpertByExpCode.county }'
							codeType='County'></tlds:name>
						${sessionScope.govExpertByExpCode.address }
				</span>
				</td>
			</tr>
			<tr>
				...
				<td colspan="3"
					...
					id="businessType"> <tlds:name
							codeCode='${sessionScope.govExpertByExpCode.businessclss }'
							codeType='IndustryCategories'></tlds:name>
				</span>
				</td>
			</tr>
			<tr>
				...
				<td style="border-bottom:1px solid #CCC;border-left:1px solid #CCC;">
					<span style="font-size: 16px;" name="person" id="person">
						${sessionScope.govExpertByExpCode.exName } </span>
				</td>
				<td
				...
				<td style="border-bottom:1px solid #CCC;border-left:1px solid #CCC;">
					<span style="font-size: 16px;" name="telephone" id="telephone">
						${sessionScope.govExpertByExpCode.phone } </span>
				</td>
			</tr>
			<tr>
...
<script type="text/javascript">
	function inveStigate() {
		var organ = document.getElementById("expcode").value;
		...
		if (inveDate == "" || inveDate == "请选择评估日期") {
			...
			$.ajax({
				type : "post",
				url : "${basePath}/subScribe/inveStigateExpertSubmit",
				data : JSON.stringify({
					"expcode" : organ,
					"evaDate" : inveDate
				}),
