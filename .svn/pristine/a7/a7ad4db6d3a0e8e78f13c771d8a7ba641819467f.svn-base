  	...
  	<div class="tab-top-div">
		...
		<table class="nav-tab">
			...
			<tr>
				...
				<td colspan="2">
					${tempUser.businessLicenseNo }
				</td>
				<td colspan="2">安全生产许可证号</td>
				<td colspan="2">
					${tempUser.safetyLicenseNo }
				</td>
			</tr>
			<tr>
...
财产损失免赔额为人民币1000元</td>
			...
			<tr>
				...
				<td colspan="6">自<%=request.getAttribute("startDate")%>日00:00:00时起 至<%=request.getAttribute("endDate")%>日23:59:59止(以最终签发的保险单为准)为保证保险合同在拟定的保险起期生效，请您在保险起期前5个工作日前办理投保手续、提交投保资料并支付保费。如您未能按时办理投保手续或保费未能按时到账，导致保险合同未在拟定的保险起期生效，发生保险事故，本公司不承担保险责任。</td>
			</tr>
			<tr>
	...
	<script type="text/javascript">
		function goZus() {
			fom.action = "${basePath}/policyUser/insertPolicyEnd";
