		...
		<div class="neicont_main_left_cont">
			...
			<div class="neicont_main_left_cont_main">
				...
				<div style="width:49.5%;float:left;">
					<c:if test="${not empty policyMain }">
						<table cellpadding="0" cellspacing="0" width="100%" border="0"
							...
							<tr class="table_lista">
								...
								<td
									...
									<fmt:formatDate value="${policyMain.endDate }" pattern="yyyy-MM-dd" var="ENDDate" /> 
							...
							<tr>
								...
								<td style="border-bottom:#9CF 1px solid;text-align:left;">
									<fmt:formatDate value="${policyMain.startDate}"
										pattern="yyyy-MM-dd" />至 <fmt:formatDate
										value="${policyMain.endDate}" pattern="yyyy-MM-dd" />
								</td>
							</tr>
							<tr>
								...
								<td style="border-bottom:#9CF 1px solid;text-align:left;">每人每次责任限额<c:out
										value="${itemKind0901001.unitamount }"></c:out>万元
								</td>
							</tr>
							<tr>
								<td style="border-bottom:#9CF 1px solid;text-align:left;">每次事故及累计责任限额<c:out
										value="${itemKind0901001.amount }"></c:out>万元
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td style="border-bottom:#9CF 1px solid;text-align:left;">保险费<c:out
										value="${itemKind0901001.spreadsheetpremium }"></c:out>元，（大写）： <script
										type="text/javascript">
											document
													.write(convertCurrency('${itemKind0901001.spreadsheetpremium}'))
										</script></td>
								<c:forEach items="${itemKinds}" var="kind"
									varStatus="listSize">
							...
							<tr>
								...
								<td style="border-bottom:#9CF 1px solid;text-align:left;"><c:out
										value="${policyMain.spreadsheetPremium}"></c:out>（大写）： <script
										type="text/javascript">
											document
													.write(convertCurrency('${policyMain.spreadsheetPremium}'))
										</script></td>
							</tr>
							<tr>
								...
								<td style="border-bottom:#9CF 1px solid;text-align:left;">
									<c:choose>
										<c:when test="${policyMain.argueSolution eq '1'}">
											<font>诉讼</font>
										</c:when>
										<c:otherwise>
											<font>仲裁</font>
				...
				<div style="width:49.5%;float:right;">
					<table cellpadding="0" cellspacing="0" width="100%" border="0"
						...
						<tr>
							...
							<td style="border-bottom:#9CF 1px solid;text-align:left;">
							<gc:name codeType="IndustryCategories" codeCode="${userCorp.classCode }"/>
								</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="border-bottom:#9CF 1px solid;text-align:left;"><span
								style="display:inline-block;width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
<%-- 								${userCorp.SOU} --%>
