  ...
  <body>
	...
	<input type="hidden" id="comLevel" value="${sessionScope.ggUser.comLevel }">
    	<div class="neicont_main_left_cont">
        	<div class="neicont_img"><img src="images/icotit1.jpg">用户查询</div>
            <div class="neicont_main_left_cont_main">
            <form action="${basePath }/dsmanager/adminquery" name="Adminer" method="get" target="resultFrame">
	...
	<iframe name="resultFrame" style="background-color:#F1F1F1;margin-top:10px;" src="/dsmanager/adminquery" width="100%" frameborder="0" height="100%">
		...
		<div class="select_list" style="margin:20px 0 0 20px; float: left;">
			<div id="uboxstyle">
				<select name="division" id="division" style="display: none;">
					<option value="100003">经纪公司</option>
				</select>
			</div>
		</div>
...
function getInsert(){
		...
		$j.ajax({
			type:"post",
			url:"${basePath}/dsmanager/admininsert",
			data: JSON.stringify({
				"userCode":userCode,
				"password":password,
				"userName":userName,
			...
			success: function(data){
				if(data == "success" ){
						alert("用户添加成功");
						close();
						window.location.href="/dsmanager/administrationCondition.jsp";
						return;
