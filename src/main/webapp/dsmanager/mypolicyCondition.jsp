...
function getBusinessClassByClassCode(upperId,id){
 ...
 <script type="text/javascript">
 	$(document).ready(
 		function(){
 			var url = "${basePath }/dsmanager/mypolicyqueryjj";
   ...
   <input type="hidden" id="province" value="${sessionScope.ggUser.province }">
	...
	<input type="hidden" id="comLevel" value="${sessionScope.ggUser.comLevel }">
   	<div class="neicont_main_left_cont">
       	<div class="neicont_img"><img src="images/icotit1.jpg">投保单查询</div>
           <div class="neicont_main_left_cont_main">
           <form action="${basePath }/dsmanager/mypolicyqueryjj" name="fm" id="fm" method="post" target="resultFrame">
		...
		<input id="insuredcode" name="insuredcode" class="select_list_inputa"
					style="height: 28px;  width: 150px; margin-left: -395px;" type="text" maxlength="20" value="请输入企业名称"
		...
		<div  class="select_list_all">
			...
			<div class="select_list">
					<div id="uboxstyle">
						<select name="inserdCode" id="inserdCode">
							<option value="" selected="selected">请选择保险公司</option>
			...
			<div class="select_list">
					<div id="uboxstyle">
						<select name="languagea" id="languagea">
								<option value="" selected="selected">请选择归属机构</option>
								<option value="0">经纪公司</option>
	...
	<iframe name="resultFrame" style="background-color:#F1F1F1;margin-top:10px;" width="100%" frameborder="0" height="100%">
	</iframe>
<script type="text/javascript">
	/* 查询方法 */
