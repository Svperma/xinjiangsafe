  ...
  <div class="maincont_mid_cont_right" style="height:600px;">
  	<table id="sonTab" cellpadding="0" cellspacing="0"  width="100%" border="0" style="margin-top: 10px;">
        ...
        <c:forEach items="${ggEmployeeList }" var="fList" varStatus="rowIndex">
          ...
          <td align=center><input type="text" name="identityNo" style="height: 30px;width: 180px;margin-top: 10px;" value="${fList.identityNo }">
          </td>	
          </tr>
        </c:forEach>
      </table>
    ...
    function selectPep(){
	  ...
	  window.parent.opener.document.getElementById("sumAmountTEMP").value=sumAt;
