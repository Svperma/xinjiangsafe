...
<body onload="findArea('hidden_province1','city',2,'city1','county1');findArea('hidden_province1','city',2,'city1','county1');">
	...
	<div class="neicont_main_left_cont">
		...
		<div class="neicont_main_left_cont_main">
			<form action="${basePath }/weal/wealquery" name="weal" id="weal"
				...
				<div class="select_list_all">
					...
					<div class="select_list" style="width: 200px;">
						<input class="select_list_inputa" id="active" name="active"
							type="text" maxlength="20" value="请输入需要查询的名称"
							onfocus="if(value==defaultValue){value='';this.style.color='#000'}"
							onblur="if(!value){value=defaultValue;this.style.color='#999' }"
							style="color: rgb(153, 153, 153);">
					</div>
					<div class="select_list" style="margin-left:100px;width:40px;">
						<a href="javascript:submitWeal();">查询</a>
					</div>
					<div class="select_list" style="margin-left:100px;width:40px;">
						<a href="/jianguan/commonweal/commonwealInsert.jsp"
							style="width:150px;" target="resultFrame">事故预防费使用</a>
					</div>
					<div class="select_list" style="margin-left:120px;width:40px;">
						<a class="select_list_alink" href="javascript:wealExcel();">报表下载</a>
					</div>
				</div>
			</form>
		</div>
	...
	<iframe name="resultFrame"
		style="background-color:#F1F1F1;margin-top:10px;" src="/weal/wealinit"
...
<script type="text/javascript">
	function submitWeal() {
		...
		if (province != null || province != "选择省份") {
			var weal = document.forms["weal"];
			weal.action = "${basePath }/weal/wealquery";
			weal.submit();
		}
	...
	function wealExcel() {
		var weal = document.forms["weal"];
		weal.action = "${basePath}/weal/wealToExcel";
		weal.submit();
	}
</script>
</html>
