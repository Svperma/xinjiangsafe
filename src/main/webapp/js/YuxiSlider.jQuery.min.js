	...
	a.fn.extend({
		YuxiSlider:function(b){
			...
			return a(this).each(function(){
				...
				g=0,
				h=null,
				//<span class="num"><em class="curr-num"></em><em class="line"></em><em class="total-num"></em></span>
				//原来在下面的a标签中
				i='<div class="desc"><p class="title"><a href=""></a></p></div><div class="bg"></div>';
				b.append(i);
				var j=a("p.title a",b),
				k=a("em.curr-num",b),
				l=a("em.total-num",b),
				...
				n={},
				o={},
				p={mobileDevice:navigator.userAgent.match(/(iPhone|iPod|Android|ios)/i),
					init:function(){
						if(p.style(),p.mobileDevice){
							...
							d.width=e,
							d.height=e/g,
							b.css({fontSize:a(window).width()/640*1.285+"rem"})}b.add("img",b).width(d.width).height(d.height),
							c.width(f*d.width),
							p.description(),
							p.bindControl(),
							f>2&&c.prepend(a("li",c).last()).css({left:-d.width}),
							d.auto&&p.auto()},
							auto:function(){
								h=d.auto?setInterval(
										function(){p.moving(!0)},d.during):null},
										stop:function(){h&&clearInterval(h)},
										description:function(){
											...
											bindControl:function(){
												if(p.mobileDevice){
													if(d.control&&d.control.remove(),2>=f)
														return;
												...
												d.mousewheel&&b.on(e,function(a){
													...
													d&&clearInterval(d),b.data("timeoutId",setTimeout(function(){
														p.moving(0>c?!0:!1),
														b.removeData("timeoutId")},100))
												}),
												d.control&&d.control.on("click",function(){
													p.moving(a(this).index()?!0:!1)}).hover(function(){
														d.auto&&p.stop()},
														function(){d.auto&&p.auto()})}
												},
												moving:function(b){
													if(1!=f){
														var e=0,
