...
<body>
	...
	<div class="neicont_main_left_cont_main">
		<form action="${basePath }/policyUser/adminpage" id="fm" method="get">
				...
				<c:forEach items="${sessionScope.pagination.resultList}" var="Admin"
					...
					<td>
							<a class="table_buttonb"
								href="${basePath }/policyUser/adminedit?UserCode=${Admin.USERCODE }">编辑</a>
							<a class="table_buttona"
								href="${basePath }/policyUser/admindel?UserCode=${Admin.USERCODE }">删除</a>
					</td>
					</tr>
				</c:forEach>
			</table>
