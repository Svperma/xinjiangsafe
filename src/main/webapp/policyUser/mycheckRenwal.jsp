...
<script type="text/javascript">
	function modifyArea(parentId, childId, codeType) {
		...
		$.ajax({
			type : "get",
			url : "${basePath}/policyUser/getGgCodeByObj" + condition,
			data : {},
			dataType : "json",
	 ...
	 <div class="tab-top-div">
		...
		<table class="nav-tab">
			...
			<tr>
				...
				<td colspan="7"><input id="inName" name="inName" type="text" value="${tempUser.companyName }"></td>
			</tr>
			<tr>
				<td colspan="2">联系地址</td>
				<td colspan="2"><input id="inAddress" name="inAddress" type="text" value="${tempUser.companyAddress }"></td>
				<td colspan="2">邮箱</td>
				<td colspan="2"><input id="inEmail" name="inEmail" type="text" value="${tempUser.email }"></td>
			</tr>
			<tr>
				<td colspan="2">联系电话</td>
				<td colspan="2"><input id="inTelePhone" name="inTelePhone" type="text" value="${tempUser.telephone }"></td>
				<td colspan="2">联系人</td>
				<td colspan="2"><input id="inLinkName" name="inLinkName" type="text" value="${tempUser.linkName }"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2"><input id="alName" name="alName" type="text" value="${tempUser.companyName }"></td>
				<td colspan="2">邮箱</td>
				<td colspan="2"><input id="alEmail" name="alEmail" type="text" value="${tempUser.email }"></td>
			</tr>
			<tr>
				<td colspan="2">联系电话</td>
				<td colspan="2"><input id="alTelePhone" name="alTelePhone" type="text" value="${tempUser.telephone }"></td>
				<td colspan="2">联系人</td>
				<td colspan="2"><input id="alLinkName" name="alLinkName" type="text" value="${tempUser.linkName }"></td>
			</tr>
			<tr>
				<td colspan="2">联系地址</td>
				<td colspan="2"><input id="alAddress" name="alAddress" type="text" value="${tempUser.companyAddress }"></td>
					...
					<select style="width: 160px;"
						...
						onchange="modifyArea('city','county','County')">
							<c:forEach items="${list_city}" var="ci" varStatus="st">
								<c:if test="${TempCity == ci.codeCode}">
					...
					<select style="width: 160px;"
						name="county" id="county">
							<c:forEach items="${list_county}" var="co" varStatus="st">
								<c:if test="${TempCounty == co.codeCode}">
			...
			<tr>
				...
				<td colspan="2">
					<input id="alBusinessLicenseNo" name="alBusinessLicenseNo" type="text" value="${tempUser.businessLicenseNo }" style="width:50%;">
				</td>
				<td colspan="2">安全生产许可证号</td>
				<td colspan="2">
					<input id="alSafetyLicenseNo" name="alSafetyLicenseNo" type="text" value="${tempUser.safetyLicenseNo }" style="width:50%;">
				</td>
			</tr>
			<tr>
	...
	function goZus() {
			...
			success : function(data) {
				if(data!=1){
					...
					fom.action = "${basePath}/policyUser/getPlaceValue";
