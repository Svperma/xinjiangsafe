	...
	<div class="maincont">
		<div class="maincont_mid_cont_right">
			<div class="maincont_mid_cont_right_main">
				<form action="${basePath }/policyUser/mycheckinitPolicyPagin" id="fm"
					method="post">
					<table cellpadding="0" cellspacing="0" width="100%" border="0">
						...
						<c:forEach items="${sessionScope.pagination.resultList }"
							...
							<td align="center"><gc:name codeCode="${mycheck.INSURERCODE }"
							...
							<td align="center"><a class="table_buttonb"
								href="/policyUser/mypolicyshow?businessno=${mycheck.BUSINESSNO }" target="mainFrame">查看</a>
								</td>
							</tr>
						</c:forEach>
						<tr style="background-color:#00a6e3;">
							<td align="center" style="border:1px solid #ccc;color:#fff" colspan="2">当前页面总保费合计(元):</td>
